<%@ Page Title="Week 1" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Week1.aspx.cs" Inherits="COMP229GameProject.Contoso.Week1" %>
    ...
    <div class="row">
        <div class="col-md-offset-2 col-md-8">
            <div class="jumbotron" id="content" runat="server">
                ...
                <asp:GridView ID="CricketGridView" runat="server" AutoGenerateColumns="false"
